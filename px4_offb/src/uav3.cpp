...
px4_movros::px4_movros()
{
    ...
    /*FCU state*/
    state_sub = nh.subscribe<mavros_msgs::State>("uav3/mavros/state", 10, &px4_movros::state_cb,this);
    ...
    arming_client = nh.serviceClient<mavros_msgs::CommandBool>("uav3/mavros/cmd/arming");
    /*Set FCU operation mode*/
    set_mode_client = nh.serviceClient<mavros_msgs::SetMode>("uav3/mavros/set_mode");
    /*Local position from FCU. NED坐标系(惯性系)*/ 
    local_pos_sub = nh.subscribe<geometry_msgs::PoseStamped>("uav3/mavros/local_position/pose", 10,&px4_movros::local_pose_cb,this); 
    /*订阅位置设置消息*/

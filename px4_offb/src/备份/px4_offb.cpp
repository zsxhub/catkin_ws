...
px4_movros::px4_movros()
{
    ...
    /*FCU state*/
    state_sub = nh.subscribe<mavros_msgs::State>("mavros/state", 10, &px4_movros::state_cb,this);
    ...
    local_pos_sub = nh.subscribe<geometry_msgs::PoseStamped>("mavros/local_position/pose", 10,&px4_movros::local_pose_cb,this); 
    /*订阅位置设置消息*/
    ...
    vrpn_sub = nh.subscribe<geometry_msgs::PoseStamped>("vrpn_client_node/bebop3/pose", 10,&px4_movros::vrpn_cb,this);
}
...
void px4_movros::vrpn_cb(const geometry_msgs::PoseStamped::ConstPtr& msg)
{

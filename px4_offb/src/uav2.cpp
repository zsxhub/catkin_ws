...
px4_movros::px4_movros()
{
    ...
    /*FCU state*/
    state_sub = nh.subscribe<mavros_msgs::State>("uav2/mavros/state", 10, &px4_movros::state_cb,this);
    ...
    local_pos_sub = nh.subscribe<geometry_msgs::PoseStamped>("uav2/mavros/local_position/pose", 10,&px4_movros::local_pose_cb,this); 
    /*订阅位置设置消息*/
